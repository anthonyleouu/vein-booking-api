...
function buildTransferConfirmationEmail(booking) {
  ...
  const bodyHtml = `
    <div style="font-size:16px;line-height:1.7;color:#2b2b2b;">
      ...
      <p style="margin:0 0 8px 0;">
        If you need to modify or cancel your booking, please use the link below or contact us as soon as possible.
      </p>
    </div>
  `;
  ...
  const html = baseEmailLayout({
    ...
    secondaryLabel: booking.cancel_url ? "Cancel this booking" : null,
    secondaryUrl: booking.cancel_url || null,
    footerLines,
  });

  const cancelLine = booking.cancel_url
    ? `\nCancel this booking: ${booking.cancel_url}\n`
    : "";
