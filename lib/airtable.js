...
function tableWithDefault(nameEnvVar, defaultName) {
...
module.exports = {
  ...
  zonesTable: () => tableWithDefault("AIRTABLE_TABLE_ZONES", "Zones"),
  routePricingTable: () => tableWithDefault("AIRTABLE_TABLE_ROUTE_PRICING", "RoutePricing"),
};